...
> Άνοιγμα αυτής της σελίδας στο [https://katsigaros.github.io/flashing-heart/](https://katsigaros.github.io/flashing-heart/)
...
* αναζήτηση για **https://github.com/katsigaros/flashing-heart** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/katsigaros/flashing-heart/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/katsigaros/flashing-heart** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/katsigaros/flashing-heart/raw/master/.github/makecode/blocks.png)
